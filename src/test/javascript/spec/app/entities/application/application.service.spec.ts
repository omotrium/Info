    ...
    describe('Application Service', () => {
        ...
        describe('Service methods', () => {
            ...
            it('should create a Application', () => {
                service.create(new Application(null)).subscribe(received => {
            ...
            it('should update a Application', () => {
                service.update(new Application(123)).subscribe(received => {
            ...
            it('should return a Application', () => {
