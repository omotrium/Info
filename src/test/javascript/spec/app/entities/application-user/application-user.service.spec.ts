    ...
    describe('ApplicationUser Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/application-users';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ApplicationUser', () => {
                service.create(new ApplicationUser(null)).subscribe(received => {
            ...
            it('should update a ApplicationUser', () => {
                service.update(new ApplicationUser(123)).subscribe(received => {
            ...
            it('should return a ApplicationUser', () => {
            ...
            it('should return a list of ApplicationUser', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ApplicationUser(123)]);
            });
